...
5. [Examples](#_toc180675738)
   ...
   * [Bugs & Limitations](#_toc180675742)
6. [To Do](#_toc180675743)
7. [For developers](#_toc180675744)
   * [AudioControlEtherNet](#_toc180675745)
   * [Subscriptions](#_toc180675746)
   * [Queues](#_toc180675747)
8. [Other VBAN Sub-protocols](#_toc180675748)
...
*`subscribe(streamName, hostName)`* connects to an incoming stream. *`hostName`* may be omitted for output streams where the stream is to be broadcast, or for inputs where there is only one other host emitting that streamName on the network. Currently this form of *`subscribe()`* is not enabled for output streams.

**hostName is FQDN or just bare – Voicemeeter needs FQDN\*\*\*\*\*\*\*\*\*\*\*\*\*\***
